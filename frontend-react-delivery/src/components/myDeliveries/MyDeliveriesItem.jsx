...
const Delivery = ({ delivery, reload, setReload }) => {
  ...
  const changeToDelivered = () => {
    Axios.put(
      `${BASE_URL}/delivery/${delivery.id}/delivered`,
      {},
      {
        headers: {
  ...
  return (
    <>
      ...
      >
        ...
        <td>{delivery.order.restaurantName}</td>
        ...
        <td>{delivery.delivered ? "Delivered" : "Pending"}</td>
      </tr>
